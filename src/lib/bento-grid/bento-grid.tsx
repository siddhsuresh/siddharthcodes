  ...
  return (
    ...
    >
      ...
      <div className="transition duration-200 group-hover/bento:translate-x-2">
        {icon}
        <div className="text-neutral-600 dark:text-neutral-200 mb-2 mt-2 font-sans font-bold">
          {title}
        </div>
        <div className="text-neutral-600 dark:text-neutral-300 font-sans text-xs font-normal">
          {description}
        </div>
      </div>
    </div>
